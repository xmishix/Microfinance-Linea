...
1. Traditional MFIs → Inclusive but costly, opaque, and slow.
2. DeFi → Efficient but exclusive, over-collateralized, and volatile.
3. Digital MFIs → Improved reach but still centralized.
